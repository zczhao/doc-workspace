...
![](./images/20190922144831.png)

## 2、选择自定义(高级)，点击下一步。出现如下界面，然后选择第三个选项：稍后安装操作系统，点击下一步

![](./images/20190922144953.png)

![](./images/20190922145026.png)

## 3、客户机安装操作系统选择 Linux,版本根据自己下载的 Linux 镜像文件来选择，这里我们选择 CentOS 64 位。然后点击 下一步

![](./images/20190922145131.png)

## 4、给虚拟机命名，以及选择虚拟机安装的位置，最好是非中文不含空格的地址。然后点击下一步

![](./images/20190922145255.png)

## 5、配置处理器，内存大小，默认，磁盘大小 20 GB足够。然后点击下一步

![](./images/20190922145351.png)

![](./images/20190922145443.png)

![](./images/20190922145517.png)

![](./images/20190922145555.png)

![](./images/20190922145637.png)

![](./images/20190922145721.png)

![](./images/20190922145805.png)

![](./images/20190922145838.png)

## 6、点击完成按钮

![](./images/20190922145926.png)

## 7、点击编辑虚拟机设置

![](./images/20190922150030.png)

弹出如下

![](./images/20190922150210.png)
...
![](./images/20190922150757.png)

## 10、进入欢迎界面后，选择 第一个选项：Install or upgrade an existing system ，然后 Enter。

　　　  注意：我们鼠标进入安装界面后，需要按 Ctrl+Alt 才能使得鼠标恢复到自己的主系统

![](./images/20190922150902.png)

## 11、选择 中文简体，点击 Next

![](./images/20190922151242.png)

## 12、安装选项

![](./images/20190922151503.png)

## 13、安装位置

![](./images/20190922151738.png)

![](./images/20190922152122.png)

## 14、开始安装

![](./images/20190922152244.png)

![](./images/20190922152348.png)

## 15、安装完成

![](./images/20190922153323.png)

## 16、输入用户名、密码登录Linux系统

![](./images/20190922153510.png)

## 17、网络配置

### 1、点击VMware虚拟机左上角的“编辑”，选择“虚拟网络编译器”

![](./images/20190922154714.png)

### 2、选中VMnet8（NAT模式），再点击右侧的“NAT设置”此时会看到如下界面

![](./images/20190922154814.png)
...
### 5、用ip addr查看IP,并用命令ping测试网络的连通性
